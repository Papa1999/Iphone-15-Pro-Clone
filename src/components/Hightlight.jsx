...
export default function Highlight() {
  return (
    <section
      id="Hightlight"
      className="w-full h-screen text-white flex flex-col justify-evenly  bg-[#232323]"
    >
      ...
      <div
        ...
        className="carousel max-md:container my-10 xl:pl-[70px] flex gap-[40px] overflow-clip "
      >
        <Carousel />
        <Carousel />
      </div>
      <div className="w-[250px] h-[55px] flex self-center ">
